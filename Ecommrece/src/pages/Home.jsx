...
import { ArrowRight, Star, ShoppingBag, Zap, Heart, ShieldCheck, Truck, RotateCcw } from 'lucide-react';
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-5">
            ...
            <h2 className="text-5xl font-serif text-luxury-navy mb-8 leading-tight">
              Curated Selections for <span className="italic">Every Occasion</span>
            </h2>
            <p className="text-slate-600 leading-relaxed mb-10">
              From the boardrooms of London to the beaches of St. Tropez, find the perfect ensemble that speaks of your journey and taste.
            </p>
          ...
          <div className="md:col-span-7 grid grid-cols-2 gap-4">
            <motion.div whileHover={{ scale: 0.98 }} className="h-[500px] rounded-none overflow-hidden relative group">
            ...
            <motion.div whileHover={{ scale: 0.98 }} className="h-[400px] mt-24 rounded-none overflow-hidden relative group">
            ...
            {products.map((product) => (
              ...
              >
                <div className="relative aspect-[3/4] mb-6 overflow-hidden bg-luxury-gold-light">
                  ...
                  <button className="absolute top-4 right-4 p-3 bg-white/80 backdrop-blur-md rounded-none text-luxury-charcoal hover:text-red-500 transition-colors shadow-sm">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="relative h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center text-white max-w-2xl px-8">
            <h2 className="text-5xl font-serif italic mb-8">Elevating the Every Day</h2>
            <p className="text-lg font-light leading-relaxed mb-12 text-slate-100">
            ...
            <button className="px-12 py-5 bg-white text-luxury-navy font-bold tracking-widest uppercase text-xs hover:bg-luxury-gold hover:text-white transition-all shadow-2xl">
